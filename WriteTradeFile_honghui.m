...
for ipart = 1:N_PART
    ...
    sfile_today = [dir_tradefile sfile_name '.xlsx'];
    bfile_today = [dir_tradefile bfile_name '.xlsx'];
    ...
    if copyfile(file_modle, sfile_today,'f') == 1
        ...
        dst_sfile_today = [dir_history 'HistoricalTrade\' sfile_name '_' num2str(idate) '_' num2str(itime) '.xlsx'];
    ...
    if copyfile(file_modle, bfile_today,'f') == 1
        ...
        dst_bfile_today = [dir_history 'HistoricalTrade\' bfile_name '_' num2str(idate) '_' num2str(itime) '.xlsx'];
