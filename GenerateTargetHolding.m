...
strategy_dir           = [AccountInfo{6}{2} 'stockStrategy\'];
stockdata_base    = strategy_dir;
co_forbiden_files = [AccountInfo{6}{2} 'currentHolding\co_forbiden_list.txt'];
stockdata_dir        = [stockdata_base sdate '\'];
file_share              = [AccountInfo{6}{1} AccountInfo{2}{i} '\share_' sdate '.txt'];
holdings_dir          = [AccountInfo{6}{2} 'currentHolding\' AccountInfo{2}{i} '\'];
current_file           = [holdings_dir 'current_holdings_' sdate '.txt'];
