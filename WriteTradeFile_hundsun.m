function WriteTradeFile_hundsun(AccountInfo, id)
global fid_log
...
for ipart = 1:N_PART
    ...
    file_today = [dir_tradefile file_name '.xlsx'];
    ...
    if copyfile(file_modle, file_today,'f') == 1
        ...
        dst_file_today = [dir_history 'HistoricalTrade\' file_name '_' num2str(idate) '_' num2str(itime) '.xlsx'];
